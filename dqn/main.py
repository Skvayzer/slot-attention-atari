    ...
    while True:
        ...
        while not done:
            ...
            if count > 3:
                ...
                save_image(img, os.path.join("/mnt/data/users_data/smirnov/sa_atari/datasets/seaquest_120000", mode, mode + '_' + str(i) + '.png'))
                # img = env.render()
                i += 1
...
if __name__ == '__main__':
    ...
    ckpt = torch.load("/home/sa_atari/dqn_seaquest_model_120000")
