...
singularity exec instance://ml_env /bin/bash -c "
      ...
      free -m;
      cd /home/sa_atari;
      python3 -u slot_attention_atari/training_od.py --dataset 'tetrominoes' --train_path "/home/sa_atari/datasets/tetrominoes" --val_path "/home/sa_atari/datasets/tetrominoes" --task '16.04'  --beta 0 --device 'gpu' --batch_size 64 --max_steps 100000 --seed 17 --num_workers 4 --invariance;
      free -m;
";
