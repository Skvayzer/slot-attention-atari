...
singularity exec instance://ml_env /bin/bash -c "
      ...
      free -m;
      cd /home/sa_atari;
      python3 -u slot_attention_atari/training_od.py --dataset 'tetrominoes' --train_path "/home/sa_atari/datasets/seaquest_120000/train" --val_path "/home/sa_atari/datasets/seaquest_120000/val" --task '16.04' --device 'gpu' --batch_size 64 --max_epochs 100 --seed 17 --num_workers 4;
      free -m;
";
